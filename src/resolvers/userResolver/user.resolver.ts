import {Query, Resolver, Arg, Mutation, UseMiddleware, Ctx, Authorized, Args} from 'type-graphql';
import { userInput, User, UserReponse, IsLoginResponse, updateipInput } from '../../schema/userSchema/user.schema';
...
export default class UserResolver {
    ...
    @Authorized()
    @Mutation(()=>UserReponse)
    updateSingleFieldByEmpId(@Arg('input') input:updateipInput){
